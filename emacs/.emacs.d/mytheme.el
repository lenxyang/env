...
(defun color-theme-lenxyang ()
  ...
  (color-theme-install
   '(color-theme-lenxyang
     ...
     ;(default ((t (nil))))
     (default ((t (
		   :stipple nil :background "black" :foreground "grep90"
			    :inverse-video nil :box nil :strike-through nil
			    :overline nil :underline nil :slant normal
			    :weight bold :height 240 :width normal
			    :family "Courier New"))))
     (fixed ((t (:bold t))))
     (bold ((t (:bold t))))
     (italic ((t (:italic t))))
     ...
     (font-lock-doc-string-face ((t (:foreground "light gree"))))
     ...
     (font-lock-type-face ((t (:bold t :foreground "dark gray"))))
     ...
     (mode-line-inactive ((t (:background "gray16" :foreground "gray60"))))
